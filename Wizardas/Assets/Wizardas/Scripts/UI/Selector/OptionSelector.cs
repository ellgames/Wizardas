...
{
    public class OptionSelector : SerializedMonoBehaviour
    {
        [Title("Settings")]
        [OdinSerialize] List<Option> m_Options;
        ...
        public int? SelectedIndex()
        {
            ...
            {
                if (m_Options[index].IsSelected) return index;
            }
        ...
        {
            Debug.Assert(0 <= index && index < m_Options.Count);
            Unselect();
        ...
        public void Decide()
        {
            ...
            m_Options[(int)selectedIndex].Decide();
