...
{
    public class HellFlameFissureCommand : UseSkillCommandBase
    {
        [Title("Settings")]
        ...
        [Space]
        [OdinSerialize] AudioClip m_HellFlameFissureAudioClip;
        [OdinSerialize] float m_HellFlameFissureAudioClipDelay = 0.2f;
        [OdinSerialize] float m_HellFlameFissureVolumeScale = 0.8f;
        [Space]
        ...
        [OdinSerialize] string m_HellFlameFissureAnimationName;
        ...
        public override void Execute()
        {
            ...
            Debug.Assert(m_HellFlameFissureAudioClip != null);
            StartCoroutine(DelayedRun(m_SwingAudioClipDelay, () => m_SEPlayer.PlayOneShot(m_SwingAudioClip, m_SwingVolumeScale)));
            StartCoroutine(DelayedRun(m_HellFlameFissureAudioClipDelay, () => m_SEPlayer.PlayOneShot(m_HellFlameFissureAudioClip, m_HellFlameFissureVolumeScale)));

            Debug.Assert(m_Animator != null);
            m_Animator.SetTrigger(m_HellFlameFissureAnimationName);
